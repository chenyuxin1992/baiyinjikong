...
window.BMAP_AUTHENTIC_KEY = 'HITuN55jkXdnAG2owYD8SwGxH8Paaltd';
(function () {
  function aa(a) {
    throw a;
  }
  ...
  A.BK = (function () {
    ...
    a.prototype = {
      ...
      move: function (a) {
        ...
        if (
          10 < Math.abs((this.Ak ? a.touches[0].clientX : a.clientX) - this.Qt) ||
  ...
  A.extend(Ma.prototype, {
    ...
    fk: function (a, b, c, e) {
      ...
      c && Q.VD(c) && ((this.be = new J(c.lng, c.lat)), (i = t));
      if ((c = c && e ? g.ii(c, this.Lb) : this.Tb))
        if (((this.Tb = new J(c.lng + a * f, c.lat - b * f)), (a = g.nh(this.Tb, this.Lb)) && i))
          this.be = a;
    },
    Ig: function (a, b) {
      if (
        Za(a) &&
        (this.Du(), this.dispatchEvent(new P('onzoomstart')), (a = this.En(a).zoom), a !== this.Xa)
      ) {
        this.xc = this.Xa;
        this.Xa = a;
        var c;
    ...
    y3: function (a, b) {
      ...
      b.styleJson
        ? (i += 'styles=' + encodeURIComponent(this.lF(b.styleJson, parseInt(a, 10))))
        : b.styleId && (i += 'styles=' + encodeURIComponent(c.lF(c.L_, parseInt(a, 10))));
    ...
    Bt: function (a) {
      ...
      if (a) {
        ...
        Ra(5050, c);
        a.style &&
          (c = b.M.UB[a.style] ? b.M.UB[a.style].backColor : b.M.UB.normal.backColor) &&
  ...
  // D.nd =
  //   D.url.proto +
  //   ('2' == D.$t ? D.url.domain.main_domain_nocdn.other : D.url.domain.main_domain_nocdn.baidu) +
  //   '/';
  // D.oa =
  //   D.url.proto +
  //   ('2' == D.$t ? D.url.domain.main_domain_cdn.other[0] : D.url.domain.main_domain_nocdn.baidu) +
  //   '/';
  // D.Yi = D.url.proto + D.url.domain.main_domain_cdn.webmap[0] + '/';
  // 替换本地资源路径
  D.fp = D.nd = D.oa = D.Yi = BMapCFG.home;
  D.di = function (a, b) {
    var c,
      e,
      b = b || '';
  ...
  function zb(a) {
    ...
    b >= a.xz
      ? ($a(a.m.za) && a.m.za(a.m.ac(1)),
        ...
        0 < a.ag.length && ((b = a.ag[0]), (b.ag = [].concat(a.ag.slice(1))), b.start()))
    ...
    void (function (a, b, c) {
        ...
        (c.alog('cus.on', 'time', function (a) {
          ...
          if ('[object Object]' === a.toString()) {
            for (var i in a)
              'page' == i
                ? (b.page = a[i])
                : ((f = parseInt(a[i])), 0 < f && /^z_/.test(i) && ((e = p), (b[i] = f)));
      ...
      if (v && v.th && m() < v.th) {
        var C = ['Moz', 'O', 'ms', 'Webkit'],
          ...
          sj = function () {
            return (
              !!b.createElementNS && !!b.createElementNS('http://www.w3.org/2000/svg', 'svg').x2
            );
          },
          tj = function () {
            return !!a.h1;
          ...
          Aj = function () {
            return (
              ...
              ('Notification' in a && 'permission' in a.iP && 'requestPermission' in a.iP)
            );
          },
          Bj = function () {
            for (
  ...
  wc.prototype.contains = function (a) {
    return a.lng > this.yg.lng && a.lng < this.Fg.lng && a.lat > this.yg.lat && a.lat < this.Fg.lat
      ? mc
  ...
  function oa(a, b) {
    // 屏蔽外部资源调用
    if (
      a.indexOf('qt=verify') > -1 ||
      a.indexOf('qt=business_accredit') > -1 ||
      a.indexOf('qt=cen') > -1 ||
      a.indexOf('qt=vtileQuest') > -1
    ) return;
    if (b) {
  ...
  A.object.extend(Ta, {
            ...
            setTimeout(function () {
              ...
              if (a.length > 0) {
                for (let i = 0; i < a.length; i++) {
                  const mf = `${BMapCFG.home}modules/${a[i]}.js`;
                  oa(mf);
    ...
    ob: function (a) {
      this.Qd.tl[a] ||
        ((this.Qd.tl[a] = {}), (this.Qd.tl[a].Le = this.Bj.bG), (this.Qd.tl[a].zu = []));
      return this.Qd.tl[a];
    },
    remove: function (a) {
      delete this.ob(a);
    ...
    DK: function () {
      for (var a = this.Qd.Dv, b = 0, c = a.length; b < c; b++) this.RZ(a[b].zM, a[b].rE);
      this.Qd.Dv.length = 0;
    },
  });
  ...
  A.extend(Cc.prototype, {
    ...
    remove: function () {
      this.P = q;
      this.R &&
        (this.R.parentNode && this.R.parentNode.removeChild(this.R), (this.R = this.R.Oq = q));
    },
    Fa: function () {
  ...
  A.object.extend(hb.prototype, {
    ...
    rV: function (a) {
      return !(a instanceof hb) || this.rj() || a.rj()
        ? t
        : a.Me > this.Me && a.He < this.He && a.Zd > this.Zd && a.Wd < this.Wd;
    },
    Nb: function () {
    ...
    Os: function (a) {
      if (
        ...
        Math.max(a.Zd, a.Wd) < Math.min(this.Zd, this.Wd) ||
        Math.min(a.Zd, a.Wd) > Math.max(this.Zd, this.Wd)
      )
        return q;
    ...
    Mr: function (a) {
      return !(a instanceof Q || a instanceof J) || this.rj()
        ? t
        : a.lng >= this.Me && a.lng <= this.He && a.lat >= this.Zd && a.lat <= this.Wd;
    },
    extend: function (a) {
      if (a instanceof Q || a instanceof J) {
        var b = a.lng,
    ...
    sF: function () {
      return this.rj()
        ? new Q(0, 0)
        : new Q(Math.abs(this.He - this.Me), Math.abs(this.Wd - this.Zd));
    },
  });
  ...
  A.extend(T, {
    ...
    ue: function (a, b, c, e) {
      return (
        this.$O * Math.acos(Math.sin(c) * Math.sin(e) + Math.cos(c) * Math.cos(e) * Math.cos(b - a))
      );
    },
    Tk: function (a) {
  ...
  A.extend(Vc.prototype, {
    ...
    Oc: function () {
      return !this.ba || 'none' == this.ba.style.display || 'hidden' == this.ba.style.visibility
        ? t
        : p;
    },
  });
  ...
  ib.prototype.$c = function (a) {
    this.map &&
      (this.map.Wc(), (a.Ua = p), (this.map.aa.nl = a), (a.tb = this), A.lang.Ha.call(a, a.ca));
  };
  ib.prototype.Wc = function () {
    this.map &&
      this.map.aa.nl &&
      ((this.map.aa.nl.Ua = t), A.lang.Dw(this.map.aa.nl.ca), (this.map.aa.nl = q));
  };
  ...
  A.extend(rd.prototype, {
    ...
    qL: function (a, b, c) {
      ...
      n = 0;
      for (e = a.childNodes.length; n < e; n++) (y = a.childNodes[n]), (y.Lq = t), this.Oe.push(y);
      ...
      for (e = this.Ce.length; n < e; n++) {
        ...
        for (o = this.Oe.length; y < o; y++)
          if (((s = this.Oe[y]), s.id == m + '_' + b + '_' + C + '_' + k + '_' + g)) {
            s.Lq = p;
            this.Bm[s.id] = s;
            break;
          }
      ...
      n = 0;
      for (e = this.Oe.length; n < e; n++) (s = this.Oe[n]), s.Lq || this.Pe.push(s);
      this.pF = [];
    ...
    AD: function (a, b) {
      return this.map.wa() === Qa
        ? 'TILE-' + b.ca + '-' + this.map.nw + '-' + a[0] + '-' + a[1] + '-' + a[2]
    ...
    ZU: function (a, b) {
      for (
        ...
        if (m >= e) {
          ...
          m <= f &&
            ((m -= c), (n = 'id_' + m + '_' + k + '_' + b), a[n] || ((a[n] = p), g.push([m, k])));
      }
      ...
      for (var k = 0; k < c; k++) {
        ...
        if (!m.G1 && !((m.vx && !this.map.Od()) || (m.VL && this.map.Od()))) {
          ...
          for (E in C) {
            var F = C[E],
              G = F.info;
            (G[2] != w || (G[2] == w && (v > G[0] || y <= G[0] || o > G[1] || f <= G[1]))) &&
              this.lx(F);
          }
          ...
          if (f.z_ == p) {
            ...
            f.getTilesUrl = function (b, e) {
              ...
              n = a.styleStr
                ...
                : n + ('&customid=' + a.style);
              const tdir = BMapCFG.tiles_dir || `${BMapCFG.home}tiles`;
              return `${tdir}/${e}/${f}/${m}${BMapCFG.imgext}`;
  ...
  var Od = {
    parse: function (a, b, c, e, f) {
      for (
        ...
        y.m6 = z[2];
        for (
          var B = (z[0] * c * k - n) / k + s / 2, C = (o - (z[1] + 1) * c * k) / k + v / 2, E = 0;
          E < a[w].length;
          E++
        )
          a[w][E].aM
              ...
              if (E) {
                ...
                this.fs(b, c, e, E, function (a) {
                  for (var c = 0; c < a.vf.length; c++)
                    F.uK(b, a.vf[c].ce, a.vf[c].de, a.vf[c].text, a.style, e);
                });
              } else this.fs(b, c, e);
            if (c.style && !E)
              for (E = 0; E < c.vf.length; E++)
                this.uK(b, c.vf[E].ce, c.vf[E].de, c.vf[E].text, c.style, e);
          } else if ('line' === c.type)
            for (E = 0; E < c.KO.length; E++)
              (f = c.KO[E]), Od.gW(b, f.ce, f.de, f.yU, f.IO, f.width, f.height, c.style, e);
      return m;
    },
        ...
        for (v = 0; v < b; v++)
          if (c.Oc(a[7][v], k)) {
            ...
            for (var B = 2 * v * z, B = C.slice(B, B + 2 * z), S = 0; S < z; S++) {
              ...
              if (F === l) (F = Z - Ga / 2), (G = Aa - o / 2), (K = F + Ga), (O = G + o);
              else {
                var sa = Z - Ga / 2,
                  Va = Aa - o / 2;
                sa < F && (F = sa);
    ...
    rK: function (a, b, c, e, f) {
      ...
      m !== q && n !== q
        ? this.jW(a, b, c, 8, m, n)
        : e && o
        ? ((m = Math.ceil(b.vf[0].width) + 6), this.cW(a, b, c, 12, m, c.height / 2))
      ...
      for (var f = 0, g = a.length; f < g; f++)
        for (var i = a[f], k = 0, m = i.length; k < m; k++) {
          ...
          if ('fixed' === n.type) {
            var y = n.Ls,
              z = n.vf;
            y && ((o = y.ce), (s = y.de), (v = y.ce + y.width), (w = y.de + y.height));
            for (y = 0; y < z.length; y++) {
              ...
              o !== l
                ? (B.ce < o && (o = B.ce),
                  ...
                  B.de + B.height > w && (w = B.de + B.height))
                : ((o = B.ce), (s = B.de), (v = B.ce + B.width), (w = B.de + B.height));
            }
          } else
            'line' === n.type
              ? ((o = n.Uf), (s = n.Vf), (v = n.li), (w = n.mi))
              : 'biaopai' === n.type &&
                ((w = n.a5), (o = w.ce), (s = w.de), (v = w.ce + w.width), (w = w.de + w.height));
      ...
      if (a[0])
        for (var g = 0; g < a[0].length; g++) {
          ...
          k === Wd
            ...
            ? Ud.drawLink(i, b, c, e, this)
            : k === Zd
            ? (Ld.drawGaoqingRoadBorder(i, b, c, e, this), Ld.drawGaoqingRoadFill(i, b, c, e, this))
            : 18 === k
          ...
          if (k)
            for (var m = 0; m < k.length; m++)
              for (var n = k[m], o = 0; o < n.length; o++)
                if (((a = n[o]), !a.Qs && a.Ls && b > a.Uf && b < a.li && c > a.Vf && c < a.mi)) {
                  b = a.Ls;
                  b = {
                    type: 9,
                    name: a.name,
  ...
  ea.ep = function (a) {
    ...
    for (k = this.Oe.length; b < k; b++)
      (w = this.Oe[b]), w.Lq || ((w.rB = q), delete w.rB, (w.yn = t), this.Pe.push(w));
    o = [];
    v = f * this.Hc;
    b = 0;
    for (k = a.length; b < k; b++) {
  ...
  A.extend(fb.prototype, {
    ...
    xp: function (a) {
      this.m.Fk =
        'number' == typeof a && !isNaN(a) ? (1 > a ? fb.Pp : a > fb.dn ? fb.Pp : a) : fb.Pp;
    },
    nf: function () {
      return this.m.Fk;
    },
  ...
  function Pa(a, b) {
    function c() {
      f.m.visible
        ? ('inter' === f.Je && Wa() && f.m.haveBreakId && f.m.indoorExitControl === p
            ? A.U.show(f.Iq)
            : A.U.$(f.Iq),
          ...
          if (a.id != b.Iv) {
            ...
            if (b.rl) {
              ...
              c =
                ...
                Math.cos(U(c)) * Math.cos(U(k)) * Math.sin(g / 2) * Math.sin(g / 2);
  ...
  function eg(a, b) {
    ...
    c.options.Uk
      ...
      : (c.Pb.style.cssText += ';position:absolute;top:' + c.y + 'px;left:' + c.x + 'px');
  ...
  eg.prototype = {
    ...
    sv: function (a) {
      ...
      this[a + 'Scrollbar']
        ? (this[a + 'ScrollbarWrapper'] ||
            ...
            this.options.NE
              ...
              : (b.style.cssText =
                  ...
                  ('h' == a
                    ...
                    : 'width:7px;bottom:' + (this.ei ? '7' : '2') + 'px;top:2px;right:1px')),
            (b.style.cssText +=
              ';pointer-events:none;' +
              Hf +
            ...
            this.options.wi &&
              (b.style.cssText +=
                ';' + Hf + 'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)'),
    ...
    br: function (a, b) {
      this.Xk ||
        ...
        this.options.Uk
          ? (this.Pb.style[Jf] =
              'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + dg)
          : ((a = Af.round(a)),
            (b = Af.round(b)),
    ...
    oQ: function (a) {
      ...
      if ('select' != b && 'input' != b && 'textarea' != b)
        return (
          a.stopImmediatePropagation ? a.stopImmediatePropagation() : (a.GZ = p),
          a.stopPropagation(),
          a.preventDefault(),
          (this.Lw = this.uB = q),
          t
      ...
      if (this.options.zoom && Sf && 1 < a.touches.length)
        (f = Af.abs(a.touches[0].pageX - a.touches[1].pageX)),
          ...
          b < this.options.Wk
            ...
            : b > this.options.Lp && (b = 2 * this.options.Lp * Math.pow(0.5, this.options.Lp / b)),
        ...
        this.qh = b.pageY;
        if (0 < f || f < this.ie)
          f = this.options.so ? this.x + c / 2 : 0 <= f || 0 <= this.ie ? 0 : this.ie;
              ...
              ? ((c = Af.max(Af.max(g.time, i.time), 10)),
                b.options.Mt &&
                  ...
                  Af.abs(g) < b.options.oy && Af.abs(i) < b.options.oy
                    ...
                    : ((g = b.OI(e, f)), (e = g.x), (f = g.y), (c = Af.max(g.time, c)))),
    ...
    Sn: function (a) {
      var b = 0 <= this.x ? 0 : this.x < this.ie ? this.ie : this.x,
        c = this.y >= this.pf || 0 < this.qd ? this.pf : this.y < this.qd ? this.qd : this.y;
      if (b == this.x && c == this.y) {
        if (
          (this.oh && ((this.oh = t), this.options.Kx && this.options.Kx.call(this)),
          this.ei &&
            this.options.kx &&
            ('webkit' == Cf && (this.zL.style[Of] = '300ms'), (this.zL.style.opacity = '0')),
          this.xi && this.options.kx)
        )
          'webkit' == Cf && (this.CO.style[Of] = '300ms'), (this.CO.style.opacity = '0');
    ...
    kU: function (a) {
      ...
      if ('zoom' == b.options.JO) {
        ...
        (c = b.x + c),
          (e = b.y + e),
          0 < c ? (c = 0) : c < b.ie && (c = b.ie),
          e > b.pf ? (e = b.pf) : e < b.qd && (e = b.qd),
          0 > b.qd && b.scrollTo(c, e, 0);
    },
    hU: function (a) {
      a.target == this.Pb && (this.$d($f), this.gB());
    },
    gB: function () {
      var a = this,
        b = a.x,
      ...
      a.Sl ||
        (a.xj.length
          ? ((f = a.xj.shift()),
            ...
            (a.oh = p),
            a.options.wi)
            ? (a.ZI(f.time), a.br(f.x, f.y), (a.Sl = t), f.time ? a.ga($f) : a.Sn(0))
            : ((i = function () {
                var k = Date.now(),
                  m;
                if (k >= e + f.time) {
    ...
    refresh: function () {
      ...
      this.Xo = this.options.Xo && 0 > this.ie;
      ...
      if ('string' == typeof this.options.Mt) {
        ...
        for (this.Xe = []; e >= this.ie; ) (this.Xe[b] = e), (e -= this.du), b++;
        this.ie % this.du &&
          (this.Xe[this.Xe.length] =
            this.ie - this.Xe[this.Xe.length - 1] + this.Xe[this.Xe.length - 1]);
        b = e = 0;
    ...
    zoom: function (a, b, c, e) {
      ...
      this.options.Uk &&
        ...
        (this.scale = c),
        this.refresh(),
        (this.x = 0 < this.x ? 0 : this.x < this.ie ? this.ie : this.x),
  ...
  D.Gk(function (a) {
    ...
    a.addEventListener('albums_visible_changed', function () {
      a.m.albumsControl === p
        ? (b ? b.Yx(a.Wb()) : ((b = new fg(a.m.albumsControlOptions)), b.ya(a)), b.show())
        : b.$();
    });
  ...
  A.extend(fg.prototype, {
    wj: function (a) {
      ...
      this.rc(this.m.anchor);
      this.R.style.width =
        isNaN(Number(this.m.maxWidth)) === p ? this.m.maxWidth : this.m.maxWidth + 'px';
    ...
    CV: function () {
      if (this.Ki && !(0 >= this.Ki.length)) {
        ...
        this.Hi &&
          (this.Hi.style.left = parseInt(this.Hi.style.left, 10) + this.fg.width + 8 + 'px');
        var b = this;
    ...
    El: function (a) {
      ...
      this.m.showCatalog &&
        (0 < this.Ki.length
          ...
          : (this.js &&
              (this.R.removeChild(this.js), (this.js = q), (this.Rc.hg.style.left = '0px')),
    ...
    scrollTo: function (a) {
      a =
        a < this.Xg.offsetLeft
          ? Math.ceil((a - this.Ai - this.Nn) / this.rr) * this.rr + this.Nn + this.Ai - 8
