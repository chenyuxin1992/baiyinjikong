...
(function () {
  ...
  z.iL = (function () {
    ...
    a.prototype = {
      ...
      move: function (a) {
        ...
        if (
          10 < Math.abs((this.Dk ? a.touches[0].clientX : a.clientX) - this.lu) ||
  ...
  z.extend(Ka.prototype, {
    ...
    ik: function (a, b, c, e) {
      ...
      if ((c = c && e ? g.vj(c, this.Ub) : this.fc))
        if (((this.fc = new J(c.lng + a * f, c.lat - b * f)), (a = g.nh(this.fc, this.Ub)) && i))
          this.re = a;
    },
    Gg: function (a, b) {
      if (
        Wa(a) &&
        (this.bv(), this.dispatchEvent(new P('onzoomstart')), (a = this.Yn(a).zoom), a !== this.Oa)
      ) {
        this.Oc = this.Oa;
        this.Oa = a;
        var c;
  ...
  // B.Wc =
  //   B.url.proto +
  //   ('2' == B.xu ? B.url.domain.main_domain_nocdn.other : B.url.domain.main_domain_nocdn.baidu) +
  //   '/';
  ...
  // 替换本地资源路径
  B.vp = B.Wc = B.ka = B.Yi = BMapCFG.home;
  B.vg = function (a, b) {
    var c,
      e,
      b = b || '';
    ...
    void (function (a, b, c) {
      ...
      if (v && v.wh && m() < v.wh) {
        var C = ['Moz', 'O', 'ms', 'Webkit'],
          ...
          Ai = function () {
            return (
              !!b.createElementNS && !!b.createElementNS('http://www.w3.org/2000/svg', 'svg').A2
            );
          },
          Bi = function () {
            return !!a.s1;
  ...
  z.object.extend(K, {
    ...
    kb: function (a) {
      this.Rd.xl[a] ||
        ((this.Rd.xl[a] = {}), (this.Rd.xl[a].Me = this.Cj.EG), (this.Rd.xl[a].Yu = []));
      return this.Rd.xl[a];
    },
    remove: function (a) {
      delete this.kb(a);
  ...
  z.extend(Vb.prototype, {
    ...
    remove: function () {
      this.B = s;
      this.C &&
        (this.C.parentNode && this.C.parentNode.removeChild(this.C), (this.C = this.C.mr = s));
    },
    Aa: function () {
  ...
  z.extend(S, {
    ...
    pf: function (a, b, c, e) {
      return (
        this.GP * Math.acos(Math.sin(c) * Math.sin(e) + Math.cos(c) * Math.cos(e) * Math.cos(b - a))
      );
    },
    Xk: function (a) {
  ...
  z.extend(mc.prototype, {
    ...
    jh: function () {
      return !this.V || 'none' == this.V.style.display || 'hidden' == this.V.style.visibility
        ? t
        : q;
    },
  });
  ...
  gb.prototype.pc = function (a) {
    this.map &&
      (this.map.Yc(), (a.Qa = q), (this.map.R.rl = a), (a.fb = this), z.lang.Ca.call(a, a.aa));
  };
  ...
  z.extend(Jc.prototype, {
      ...
      for (var i = 0; i < c; i++) {
        ...
        if (!k.pI && !((k.pp && !this.map.Sb()) || (k.GM && this.map.Sb()))) {
          ...
          for (C in E) {
            var F = E[C],
              D = F.info;
            (D[2] != g || (D[2] == g && (p > D[0] || x <= D[0] || n > D[1] || f <= D[1]))) &&
              this.Rx(F);
          }
    ...
    Yf: function (a) {
      ...
      if (a instanceof db) b && a.Im && (a.remove(), (a.Im = t));
        ...
        if (a.pp)
          for (var b = 0, c = this.Fg.length; b < c; b++) a == this.Fg[b] && this.Fg.splice(b, 1);
        else {
          b = 0;
  ...
  nd.getTilesUrl = function (a, b) {
    ...
    // 替换地图瓦片资源
    /*var tdir = bmapcfg.tiles_hybrid.length > 0 ? bmapcfg.tiles_hybrid : bmapcfg.home + "tiles_hybrid";
		tdir = tdir + "/" + b + "/" + c + "/" + e + bmapcfg.imgext;
	    return tdir;*/
    return (url =
  ...
  z.extend(cb.prototype, {
    ...
    Np: function (a) {
      this.j.Jk =
        'number' == typeof a && !isNaN(a) ? (1 > a ? cb.fq : a > cb.En ? cb.fq : a) : cb.fq;
    },
    qf: function () {
      return this.j.Jk;
    },
  ...
  Ye.prototype = {
    ...
    Sv: function (a) {
      ...
      this[a + 'Scrollbar']
        ? (this[a + 'ScrollbarWrapper'] ||
            ...
            this.options.wi &&
              (b.style.cssText +=
                ';' + Be + 'transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)'),
    ...
    Ar: function (a, b) {
      this.al ||
        ...
        this.options.Yk
          ? (this.Nb.style[De] =
              'translate(' + a + 'px,' + b + 'px) scale(' + this.scale + ')' + Xe)
          : ((a = ue.round(a)),
            (b = ue.round(b)),
  ...
  z.extend(Ze.prototype, {
    ...
    tW: function () {
      if (this.Ji && !(0 >= this.Ji.length)) {
        ...
        this.Gi &&
          (this.Gi.style.left = parseInt(this.Gi.style.left, 10) + this.ig.width + 8 + 'px');
        var b = this;
    ...
    Il: function (a) {
      ...
      this.j.showCatalog &&
        (0 < this.Ji.length
          ...
          : (this.Os &&
              (this.C.removeChild(this.Os), (this.Os = s), (this.Rc.jg.style.left = '0px')),
